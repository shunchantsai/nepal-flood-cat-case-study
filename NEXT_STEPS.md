...
Tracking file for outstanding work across modules. Kept separate from reader-facing content so
that module files (README, timeline, etc.) read as finished documents rather than drafts.
